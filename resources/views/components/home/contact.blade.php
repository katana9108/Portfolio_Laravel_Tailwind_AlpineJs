...
<section id="contact" class="relative z-10 overflow-hidden dark:bg-primary  bg-white py-20 lg:py-[120px]">
    <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                    <span class="text-primary dark:text-white mb-4 block text-base font-semibold">
                        Contact Me
                    </span>
                    <h2
                        class="text-dark  dark:text-white mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                        FOR BUSNESS ENQUIRES
                    </h2>
                    <p class="text-body-color mb-9 text-base leading-relaxed dark:text-white">
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-body-color text-base dark:text-white">(+212)6 38 34 86 65</p>
                        </div>
                    </div>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-body-color text-base dark:text-white">jeffrygayvynnsomeminko@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
