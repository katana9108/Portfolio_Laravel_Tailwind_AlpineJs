...
{{$attributes->class([
    ...
    'hover:bg-primary hover:dark-primary hover:text-white'=>$variant==='outline-primary',
    'hover:bg-red-700 hover:border-red-700 hover:text-white'=>$variant==='outline-red',
    'bg-red-700 border:red-700 text-white hover:bg-white hover:text-dark hover:border-dark-800'=>$variant==='red',
    ...
    'bg-dark border-white text-white hover:bg-success'=>$variant==='success'
])}}>
{{$slot}}
</button>
